...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "aAqY5chdBgRwEYC39b83bPCfg", consumerSecret: "o3tkqLzzP9g3HMqnLrvxjSmfPJgLddRdXp4joGNGuAz8x85JPe")
    var loginSuccess: (() -> ())?
